"""
auth.py — Secure JWT authentication for the Arkivo platform.
═════════════════════════════════════════════════════════════
All secrets loaded from config (environment variables).
"""
...
def get_current_user(
    ...
    # Fallback to query parameter (needed for <img> tags)
    if not token:
        token = token_query
